...
class Motion_predictor:
    def __init__(self):
        ...
        # creases = [[[145,-145],[-145,145]],[[-145,-145],[145,145]]]
        img_src = cv2.imread("/home/liwei/dual_arm_ws1/src/motion_detector/src/vision/cropped_sample/airplane.png")
        ...
        state='state4'
        self.motion_detector3.analysis(1)
    ...
    def imageCallback2(self,image):
        ...
        contour_img = copy.deepcopy(self.motion_detector1.state['state3']['contour_image'])
        ...
        print 'pts src',self.motion_detector1.state['state3']['contour_pts']
