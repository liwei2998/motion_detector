...
#     def __init__(self):
#         # Read in the image.
#         img_src = cv2.imread("corner_match_night/left0000.jpg")
#
#         motion_detector2 = cl.GetCreases()
#         result_img2 = motion_detector2.detect(img_src)
#
#         # Show output
#         # cv2.imshow("Original_image", img_src)
#         cv2.imshow("Image", result_img2)
#
#         cv2.waitKey(0)
