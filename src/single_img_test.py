...
##test 5: Predictor
 # For one image
    ...
    pts_src = np.array([[-145, -145], [145, -145], [145, 145], [-145, 145]])
    motion_detector2 = cl.Predictor(pts_src0,creases,creases[0],result_img1)
    ...
    # motion_detector2.get_new_contour_by_image(result_img1)
...
##test 6: get trans
    ...
    # img_src = cv2.imread('corner_match_sample6/Capture1.PNG')
    # motion_detector1 = cl.ColorFilter()
    # new_image = copy.deepcopy(img_src)
    # new_image = motion_detector1.paper_filter_temp(new_image)
    # h,(r,t),img1,img2 = motion_detector0.detect(new_image,img_src)
    # cv2.waitKey(0)
...
# test 7: get object mask
    ...
    #
    #     motion_detector0 = cl.CornerMatch_new()
    #     motion_detector0.mainFuc(img_src)
        # # motion_detector0.hsv_calc(img_src)
        # result, mask = motion_detector0.filter(img_src,'white')
        # cv2.imshow('result',result)
        # cv2.imshow('mask',mask)
        # motion_detector1 = cl.ColorFilter()
        # # result_img1, creases = motion_detector1.detect(img_src)
        # result_img1 = motion_detector1.paper_filter_temp(img_src)
        # # Show output
        # # cv2.imshow("Original_image", img_src)
        # # print "crease info", creases
        # cv2.imshow("Image", result_img1)
